...
public class Delivery extends DatabaseRow {
	...
	// Different columns of the Delivery-table in the database:
	...
	// This represents all of the dishes linked to this delivery:
	 ...
	 * Note: Added and removed dishes to a delivery are auto-committed, and
	...
	/**
	 * Gets the Customer requesting this delivery.
	 * @return The Customer
	 */
	...
	/**
	 * Sets the Customer requesting this delivery.
	...
	/**
	 * Gets the number of deliveries done.
	...
	/**
	 * Sets the number of deliveries done.
	 * @param numDelivered Number of deliveries
	 */
	...
	/**
	 * Gets the sum income from this delivery.
	...
	/**
	 * Sets the new sum income from this delivery.
	...
	/**
	 * Gets the sum outcome from this delivery.
	...
	/**
	 * Sets the new sum outcome from this delivery.
